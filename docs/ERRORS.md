...
**Curated codes** (`PDL-1001`, `PDL-2002`…) are the conditions listed below: a known meaning and a
known next step. **Automatic codes** (`PDL-U-7F3A`) cover everything not yet catalogued — derived
...
This file is generated from `src/lib/errors.ts`. Edit the catalogue there, not here.

## 1xxx · Account and sign-in

### PDL-1001 — Sign-in rejected
...
### PDL-1002 — Email never confirmed
...
### PDL-1003 — Session expired or rejected
...
### PDL-1004 — Account is banned or deleted
...
### PDL-2001 — Home screen couldn't load your sessions
...
### PDL-2002 — Expected one row, found several
...
### PDL-2003 — Your profile couldn't be read
...
### PDL-2004 — Rating or record couldn't be read
...
### PDL-3001 — Session wouldn't start
...
### PDL-3002 — Session couldn't be loaded
...
### PDL-3004 — Next round couldn't be generated
...
### PDL-3006 — Round couldn't be redrawn
...
### PDL-4001 — Club couldn't be loaded
...
### PDL-4002 — League table couldn't be built
...
### PDL-4003 — Club action was refused
...
### PDL-5001 — Join code didn't work
...
### PDL-5003 — Claiming a spot failed
...
### PDL-6001 — Image couldn't be processed
...
### PDL-6002 — Recap card couldn't be drawn
...
### PDL-9001 — The server had a problem
